...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  public boolean runTests () {
    ...
    try {
      SystemDefs sysdef = new SystemDefs( dbpath, NUMBUF+20, NUMBUF, "Unknown" ); // Substitute 'Unknown' with the name of the buffer replacement policy
    }
  ...
  protected boolean test2 () {
	...
	status = OK;
          ...
          System.err.print ("Output Expected\n");
      }
      else {
	status = OK;
      }
